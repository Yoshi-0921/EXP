...
class Exp6_Map(Map):
    ...
    """def locate_walls(self):
        ...
        self.matrix[np.array([3,4,5,8,9,10,13,14,15,18,19,20]), 5, 0] = 1
        self.matrix[np.array([1,2,3,7,8,9,10,13,14,15,16,20,21,22]), 10, 0] = 1
        self.matrix[np.array([1,2,3,7,8,9,10,13,14,15,16,20,21,22]), 13, 0] = 1
        self.matrix[np.array([3,4,5,8,9,10,13,14,15,18,19,20]), 20, 0] = 1

        self.matrix[3, np.array([8,9,10,13,14,15]), 0] = 1
        self.matrix[5, np.array([3,4,5,18,19,20]), 0] = 1
        self.matrix[7, np.array([8,9,10,13,14,15]), 0] = 1
        self.matrix[8, np.array([3,4,5,18,19,20]), 0] = 1
        self.matrix[10, np.array([8,9,10,13,14,15]), 0] = 1
        self.matrix[13, np.array([8,9,10,13,14,15]), 0] = 1
        self.matrix[15, np.array([3,4,5,18,19,20]), 0] = 1
        self.matrix[16, np.array([8,9,10,13,14,15]), 0] = 1
        self.matrix[18, np.array([3,4,5,18,19,20]), 0] = 1
        self.matrix[20, np.array([8,9,10,13,14,15]), 0] = 1
